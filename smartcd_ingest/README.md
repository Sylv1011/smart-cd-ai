...
Source: Structured output from LLM (Gemini)
...
Important: First Run in Validation Mode

Before pushing data to Supabase:
	1.	Remove Supabase credentials from .env
	2.	Run ingestion in validation-only mode: python scripts/parse_bankrate.py
...
Running Full Ingestion with Database

After validation succeeds:
	1.	Add Supabase credentials to .env: SUPABASE_URL=...
