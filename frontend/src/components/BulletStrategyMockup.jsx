    ...
    <div className={`mx-auto w-full max-w-[1288px] ${isLightTheme ? 'text-[#0F172A]' : 'text-white'}`}>
      ...
      <section className="mb-3">
        <div className="mb-4 flex items-center justify-between gap-4 max-[520px]:items-start max-[520px]:flex-col">
          ...
          <button type="button" onClick={onExportPdf || (() => {})} className="theme-keep-white inline-flex items-center gap-2 rounded-[8px] border border-transparent bg-[#0D1117] px-3 py-2 text-[14px] font-medium leading-[20px] text-white shadow-none hover:bg-[#141c2a]">
